...
(defun personal-p (msg)
  (mu4e-message-contact-field-matches msg :to "leonardo.ribeiro.santiago@gmail.com"))
(defun university-p (msg)
  (mu4e-message-contact-field-matches msg :to "leonardors@dcc.ufrj.br"))
(defun work-p (msg)
  (mu4e-message-contact-field-matches msg :to "leonardo@mixrank.com"))
#+end_src
